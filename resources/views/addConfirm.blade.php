...
<div data-role="page" id="addConfirm">
    ...
    <a href="/wshop/public/addScanInventory" data-rel="back" class="ui-btn ui-btn-inline ui-corner-all ui-shadow ui-btn-icon-left ui-icon-arrow-l">戻る</a>
		<h1>入库确认</h1>
	</div><!-- /header -->
