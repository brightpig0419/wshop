...
<body>
<div data-role="page" id="addConfirm">
	<div data-role="header"  data-add-back-btn="true">
    <a href="/wshop/public/addScanPostItemNo" data-rel="back" class="ui-btn ui-btn-inline ui-corner-all ui-shadow ui-btn-icon-left ui-icon-arrow-l">戻る</a>
		<h1>添加邮单确认</h1>
	</div><!-- /header -->

	<div role="main" class="ui-content">
	<form method="post" action="/wshop/public/addInventory" data-ajax="false">
    <table data-role="table" id="postItem" class="ui-body-d ui-shadow table-stripe ui-responsive">
            <tr>
                <td>商品图片</td>
                <td>商品名称</td>
                <td>入库数量</td>
    ...
    <table data-role="table" id="table-custom-2" data-mode="columntoggle" class="ui-body-d ui-shadow table-stripe ui-responsive" data-column-btn-theme="a" data-column-btn-text="选择项" data-column-popup-theme="a">
        <thead>
            <tr>
                ...
                <th data-priority="3">入库数量</th>
            </tr>
            </thead> 
            <tbody>
            <?php
                foreach($addProductsConfirm as $confirm){
            ?>
